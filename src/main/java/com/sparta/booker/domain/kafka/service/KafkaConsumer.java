...
//		log.debug("Processing Time for Message: {} ms", endTime - startTime);
//
...
//	@KafkaListener(topicPartitions = @TopicPartition(topic = "book-2", partitions = {"0", "1"}), groupId = KafkaProperties.CONSUMER_GROUP_ID)
...
//	}
//
//	@KafkaListener(topicPartitions = @TopicPartition(topic = "book-2", partitions = {"2", "3"}), groupId = KafkaProperties.CONSUMER_GROUP_ID)
...
//	}
//
//	@KafkaListener(topicPartitions = @TopicPartition(topic = "book-2", partitions = {"4", "5"}), groupId = KafkaProperties.CONSUMER_GROUP_ID)
...
//	}
//
//	@KafkaListener(topicPartitions = @TopicPartition(topic = "book-2", partitions = {"6", "7"}), groupId = KafkaProperties.CONSUMER_GROUP_ID)
...
//	}
//
//	@KafkaListener(topicPartitions = @TopicPartition(topic = "book-2", partitions = {"8", "9"}), groupId = KafkaProperties.CONSUMER_GROUP_ID)
